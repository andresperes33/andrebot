...
def reclassificar(apps, schema_editor):
    """Reclassifica anúncios de cupom ('NOVO Cupom Mercado Livre') que a
    regra antiga marcava como cooler/headset por termos na imagem/post."""
