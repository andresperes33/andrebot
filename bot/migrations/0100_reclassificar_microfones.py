...
def reclassificar(apps, schema_editor):
    """Reclassifica microfones ('Microfone Gamer FIFINE A8 com Controle RGB')
    que a regra antiga marcava como 'Controle / Gamepad' ou 'Headset'."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0099_reclassificar_extensoes'),
    ]
