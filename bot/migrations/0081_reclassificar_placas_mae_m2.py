...
def reclassificar(apps, schema_editor):
    """Reclassifica placas-mãe com 'M.2'/chipset no texto (ex.: 'Asus Prime
    A520M-R ... M.2 Chipset A520') que a regra antiga marcava como SSD."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0080_alter_promo_categoria'),
    ]
