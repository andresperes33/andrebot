...
def reclassificar(apps, schema_editor):
    """Reclassifica webcams ('Webcam Fifine K420 Com Microfone') que a regra
    antiga marcava como 'Microfone' por causa do microfone embutido."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0115_reclassificar_controles_switch'),
    ]
