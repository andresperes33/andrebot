...
def reclassificar(apps, schema_editor):
    """Reclassifica controles/gamepads para celular (ex.: 'Controle GameSir
    ... para iPhone/Android') que a regra antiga marcava como celular."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0082_reclassificar_processadores_x99'),
    ]
