...
def reclassificar(apps, schema_editor):
    """Reclassifica fontes de alimentação ('Fonte 850W ... com Cabo') que a
    regra antiga marcava como cabo/carregador por causa da palavra 'Cabo'."""
