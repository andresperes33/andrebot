...
def recalcular(apps, schema_editor):
    ...
    medidas (ghz/mb) e termos variáveis (max/turbo/box) não entram mais na chave."""
    Promo = apps.get_model('bot', 'Promo')
    # Aplica apenas nas promos que têm algum produto_chave (evita reprocessar tudo)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0049_reclassificar_notebooks'),
    ]
