...
def reclassificar(apps, schema_editor):
    """Reclassifica bundles de console com jogos (ex.: 'PlayStation 5 + GTA VI')
    que a regra antiga marcava como 'jogo' por causa de um jogo no título."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0052_reclassificar_notebooks_gpu'),
    ]
