...
def reclassificar(apps, schema_editor):
    """Reclassifica anúncios de cupom que falam de resgate de cupons no
    Mercado Livre (sem % OFF no texto capturado), antes marcados como outros."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0092_reclassificar_tvs_processador'),
    ]
