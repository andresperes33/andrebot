...
def reclassificar(apps, schema_editor):
    """Reclassifica produtos que têm 'cabo' apenas na URL do link
    (ex.: 'Kit Starlink ... /kit-suporte-cabo-3m-') e a regra antiga
    marcava como cabo/carregador."""
