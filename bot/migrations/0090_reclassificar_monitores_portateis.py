...
def reclassificar(apps, schema_editor):
    """Reclassifica monitores portáteis ('Monitor Portátil ... para Notebook')
    que a regra antiga marcava como 'Notebook' por causa da compatibilidade."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0089_reclassificar_coolers_processador'),
    ]
