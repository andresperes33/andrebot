...
def reclassificar(apps, schema_editor):
    """Reclassifica monitores portáteis (ex.: 'Monitor Portátil ARZOPA ...
    Tela IPS') que a regra antiga marcava como 'Notebook' por causa do
    padrão de 'Tela IPS' antes da regra de monitor."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0129_alter_promo_categoria'),
    ]
