...
def reclassificar(apps, schema_editor):
    """Reclassifica placas-mãe ('Placa-mãe ... Suporta processadores Intel')
    que a regra antiga marcava como 'Processador' por compatibilidade."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0100_reclassificar_microfones'),
    ]
