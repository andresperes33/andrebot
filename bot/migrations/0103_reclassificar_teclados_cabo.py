...
def reclassificar(apps, schema_editor):
    """Reclassifica teclados ('Teclado ... com cabo USB Tipo-C') que a regra
    antiga marcava como 'Cabo / Carregador' por compatibilidade."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0102_reclassificar_monitores_oled'),
    ]
