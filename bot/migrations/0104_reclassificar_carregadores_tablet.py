...
def reclassificar(apps, schema_editor):
    """Reclassifica carregadores ('Carregador Baseus ... para tablet, iphone')
    que a regra antiga marcava como 'Tablet' por compatibilidade."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0103_reclassificar_teclados_cabo'),
    ]
