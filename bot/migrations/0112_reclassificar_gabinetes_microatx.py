...
def reclassificar(apps, schema_editor):
    """Reclassifica gabinetes ('Gabinete Gamer ... Micro-ATX/Mid') que a regra
    antiga marcava como 'Placa-mãe' por causa de 'micro-atx' (geralmente no
    slug/URL do produto)."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0111_reclassificar_gabinetes'),
    ]
