...
def reclassificar(apps, schema_editor):
    """Reclassifica TVs ('Smart TV ... Controle AI Magic') que a regra antiga
    marcava como 'Controle / Gamepad' por causa do controle remoto incluso."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0090_reclassificar_monitores_portateis'),
    ]
