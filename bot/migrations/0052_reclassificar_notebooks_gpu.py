...
def reclassificar(apps, schema_editor):
    """Reclassifica notebooks com GPU no título (ex.: 'RTX 5050 Notebook Asus
    TUF') que a regra antiga marcava como 'placa_video'."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0051_recalcular_chave_descriptores'),
    ]
