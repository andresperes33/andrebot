...
def reclassificar(apps, schema_editor):
    """Reclassifica TVs ('Smart TV ... Modo Jogo Pro') que a regra antiga
    marcava como 'Jogo' por causa do modo jogo/sports embarcado na TV."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0093_reclassificar_cupons_resgate'),
    ]
