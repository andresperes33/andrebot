...
def reclassificar(apps, schema_editor):
    """Reclassifica câmeras de segurança ('Câmera Baseus ... painel solar 2K')
    que a regra antiga marcava como 'Monitor' por causa de 'painel'."""
