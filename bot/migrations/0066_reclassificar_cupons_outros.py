...
def reclassificar(apps, schema_editor):
    """Reclassifica anúncios de cupom ('Novos Cupons Shopee LIVE') que a regra
    antiga marcava como 'outros' por causa do texto normalizado."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0065_reclassificar_celulares_desconto'),
    ]
