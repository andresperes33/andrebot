...
def reclassificar(apps, schema_editor):
    """Reclassifica cabos/carregadores ('Cabo USB-C ... MacBook iPad') que a
    regra antiga marcava como notebook por causa de compatibilidade."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bot', '0074_alter_promo_categoria'),
    ]
